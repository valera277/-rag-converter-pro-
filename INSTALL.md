...
## Описание
Веб-приложение для конвертации PDF и TXT файлов в формат датасета для RAG-систем с системой подписки и оплатой через WayForPay.
...
### Аккаунты
- **WayForPay** мерчант-аккаунт для приема платежей
...
# Ключи WayForPay (получите в личном кабинете мерчанта)
...
#### Как получить ключи WayForPay:
1. Зайдите на https://wayforpay.com/
...
│   ├── payment/              # Интеграция с WayForPay
